...
public class GameApiService
{
    ...
    /// </summary>
    public async Task<Item[]> GetItensJogador(string jogadorId)
    {
        try
        {
    ...
    /// </summary>
    public async Task<Item> AdicionarItem(string jogadorId, Item item)
    {
        try
        {
            string url = $"{BASE_URL}/Jogador/{jogadorId}/Itens";
            ...
            return JsonUtility.FromJson<Item>(responseJson);
        }
        catch (Exception ex)
        {
    ...
    /// </summary>
    public async Task<Item> GetItem(string jogadorId, string itemId)
    {
        try
        {
    ...
    /// </summary>
    public async Task<Item> AtualizarItem(string jogadorId, string itemId, Item item)
    {
        try
        {
            string url = $"{BASE_URL}/Jogador/{jogadorId}/Itens/{itemId}";
